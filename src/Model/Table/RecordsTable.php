...
class RecordsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ->scalar('record_name')
            ->maxLength('record_name', 83)
            ->allowEmptyString('record_name');
        ...
        $validator
            ->scalar('number_of_disks')
            ->maxLength('number_of_disks', 15)
            ->allowEmptyString('number_of_disks');

        $validator
            ->integer('record_id')
            ->allowEmptyString('record_id', null, 'create');
